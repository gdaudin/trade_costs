...
\usepackage{amsmath}
\usepackage{amsthm}
%\definecolor{perso}{cmyk}{1,0,0,0}
%\hypersetup{linkcolor=perso}YellowGreen
...
Guillaume Daudin\footnote{Universit\'{e} Paris-Dauphine \& PSL University, IRD, LEDa, UMR 225, DIAL; Sciences Po, Observatoire Fran\c{c}ais des Conjonctures \'{E}conomiques (OFCE); Email: \url{guillaume.daudin@dauphine.fr}} and J\'{e}r\^{o}me Hericourt\footnote{Universit\'{e} de Lille, LEM, UMR CNRS 9221, and CEPII; Email: \url{jerome.hericourt@univ-lille.fr}} and Lise Patureau\footnote{Corresponding author. Universit\'{e} Paris-Dauphine \& PSL University, LEDa; Email: \url{lise.patureau@dauphine.fr}}
...
\subsection{Estimation at the 3-digit classification level \label{app:more_results}}

\subsubsection{Transport costs estimates: More detailed results}
...
\subsubsection{Assessing the importance of additive transport costs \label{app:diagnostic_test}}
...
\subsection{Eliminating the composition effects: More details \label{app:comp-effects}}
...
%\subsubsection{More on our methodology}
...
\subsubsection{Comparing with \cite{hummels2007} \label{app:compare_Hummels}}
