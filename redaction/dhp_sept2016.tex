...
Figure \ref{fig:totalTC_compeffects_excl} reports the results. Panel (a) displays the time changes in the observed transport costs, by transport mode. In Panels (b) and (c), we report the time changes of the ad-valorem costs and the additive costs respectively (re-scaled to start from the reference value 100), for each transport mode.
...
\todo{Laisser tomber l'observe et faire la somme I+A en pondérant par le poids respectif de chacun dans le total des TC en 1974.}
