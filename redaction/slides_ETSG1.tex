...
\begin{itemize}
\footnotesize{
\item[-] Additive trade costs, an important role in shaping the pattern of trade flows: Martin (2012), Hummels \& Skiba (2004), Irrarazabal et al. (2015) \vspace{0.1cm}
...
\begin{itemize}
\item[-] The estimated iceberg component reduces by a factor of 2 \vspace{0.1cm}
...
\end{equation}
\normalsize
\item  Taking the average over the product-country dimension, we finally get (by year and transport mode): \hyperlink{app_method_2}{\beamergotobutton{More}}\vspace{0.1cm}
\begin{itemize}
...
For both the ad-valorem and the additive components of transport costs (by year \& transport mode)\vspace{0.1cm}
\begin{itemize}
...
\begin{itemize}
\item[-] Iceberg cost: 2.5\% and 3.2\% of the export price in air \& ocean resp. \vspace{0.1cm}
\item[-] Additive cost: 1.8\% and 2.9\% of the export price  \vspace{0.1cm}
\end{itemize}
\end{itemize}
\end{frame}
...
\begin{itemize}
\item[$\star$] The ad-valorem cost reduces by a factor of 2 when additive transport costs are included in the estimation  \vspace{0.1cm}
\item[$\star$] Amounts to 3.2\% and 2.5\% as mean values in vessel and air respectively in presence of additive costs \vspace{0.1cm}
\item[$\star$] vs 5.8\% and 5.1\% when estimated alone \vspace{0.1cm}
\end{itemize}
...
\item[$\Rightarrow$] A systematically better goodness of fit when including the additive component \hyperlink{app_goodnessfit}{\beamergotobutton{More results}}
\end{itemize}
\end{itemize}
\end{frame}
...
\end{center}
\end{figure}
\item[$\Rightarrow$] Downward trend in overall transport costs, for both air and ocean shipping since 1974 \hyperlink{app_fig1}{\beamergotobutton{Robustness of this result}}\vspace{0.1cm}
\begin{itemize}
\footnotesize{
\item[-] From 1980, a 1.5- 2 percentage points decrease in Air, a 2-3 percentage point decrease in Vessel }\vspace{0.1cm}
\end{itemize}
\
\end{itemize}
\end{frame}
...
\frametitle{Time trends in transport costs: Excluding the composition effects }
\begin{itemize}
...
\item[-] The reduction between 1974 and 1984 (\hyperlink{slide_fig1}{\beamergotobutton{Figure 1}}), attributable to change in the composition of trade patterns \vspace{0.1cm}
\end{itemize}
...
\item[-] A result in accordance with Hummels (2007), Behar \& Venables (2011) \vspace{0.1cm}
...
\end{itemize}
\item[-] Then, take the (weighted) average by country-product
\end{itemize}
\end{itemize}
\hyperlink{slide_method}{\beamergotobutton{Back to slide}}
\end{frame}
