...
\item[$\neq$] Our results: Quantitatively estimate the \textit{value} of the additive costs \vspace{0.1cm}
...
\item[-] What lies behind the decrease in transportation costs observed in the recent decades? \vspace{0.1cm}
\item[-] Hummels (2007): Mostly due to trade composition effects \vspace{0.1cm}
\item[$\neq$] Our results: Trade composition effects only a minor role \vspace{0.1cm}
...
\begin{frame}[label = slide_variancedecomp]
