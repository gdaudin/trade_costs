...
%\documentclass[10 pt,Helvetica, french, handout]{beamer}
...
\item Yet... A debated question \vspace{0.1cm}%\bigskip
...
\pause
\begin{itemize}
\item[$\ast$] Hummels (2007): composition effects partly offset the decrease in transport costs  \vspace{0.1cm} %XXX CAREFUL to misinterpretations here!!!XXX
...
\begin{frame}
\frametitle{Related literature: Two related strands}
\begin{itemize}
\item Challenging the dominant role of iceberg costs in international trade \vspace{0.1cm}
\begin{itemize}
\footnotesize{
\item[-] Hummels and Skiba (2004) (sectoral data), Martin (2012) (firm-level data)
\item[-] The closest to us: Irarrazabal, Moxnes and Opromolla (2015) \vspace{0.1cm}
\item[$\Rightarrow$] In support of the additive cost component assumption \vspace{0.1cm}
\pause
\item[$\neq$] \textbf{Our results: Quantitatively estimate the \textit{value} of the additive costs} \vspace{0.1cm}
\item[-] A broader view of the magnitude of additive costs \vspace{0.1cm}
%\begin{itemize}
%\item[$\star$] US import flows over 1974-2013 \vspace{0.1cm}
%\end{itemize}

\item[$\Rightarrow$] Additive costs do matter quantitatively, throughout the period} \vspace{0.1cm}
\pause
\end{itemize}
\item Studying the patterns of trade costs over time \vspace{0.1cm}
\begin{itemize}
\footnotesize{
\item[-] Hummels (2007), Behar and Venables (2011) \vspace{0.1cm}
\item[-] What is exactly behind the decrease in transportation costs observed in the recent decades? \vspace{0.1cm}
\item[-] Hummels (2007): trade composition effects partly cancelled decrease in transport costs \vspace{0.1cm}
\pause
\item[$\neq$] \textbf{Our results: Trade composition effects only had a (very) minor impact on the trend} \vspace{0.1cm}
\item[-] Why such a difference?  \vspace{0.1cm}
\item[$\Rightarrow$]Key role of the modelling of the additive component}
\end{itemize}
...
\item[(2)] All products $k$ in a 3-digit sector $s$ share the same structure of costs \hyperlink{app_variancedecomp}{\beamergotobutton{More on this}}\vspace{0.1cm}
...
\frametitle{Result 1: Size of additive transport costs }
\begin{itemize}
\item Estimate the values of both the ad-valorem and the additive components \vspace{0.1cm}
\begin{itemize}
\item[-] \footnotesize{Average values over 1974-2013, in percent of the export price \hyperlink{app_results_summary}{\beamergotobutton{On some years}}  }
\end{itemize}
\end{itemize}
\begin{table}[htbp]
  \centering
...
\begin{itemize}
\item \textbf{Size of overall transport costs} \vspace{0.1cm}
\begin{itemize}
...
\end{itemize}
\end{itemize}
\item[$\Rightarrow$] Our work: A precise estimation of international transport costs \vspace{0.1cm}
\begin{itemize}
\item[-] Going deeper into the structure of international transport costs
\end{itemize}
\end{itemize}
\end{frame}
...
\item Opening the black box of transport costs \hyperlink{app_comparison}{\beamergotobutton{More on this}} \vspace{0.1cm}
\begin{itemize}
...
Some insights on our methodology \hyperlink{app_compeffects_strategy}{\beamergotobutton{More details}} \vspace{0.1cm}
\begin{itemize}
...
%\item[$\Rightarrow$] Obtain the fitted measures $\Gamma_{t}^{add}$ and $\Gamma_{t}^{adv}$ \vspace{0.1cm}
\end{itemize}
...
%\begin{itemize}
%\item[-] Also both fitted ($\Gamma_t^{TC, pure}$) and unfitted ($\Gamma_t^{TC, raw}$)
%\end{itemize}
...
\end{center}
\end{figure}
\hyperlink{app_compeffects_Hummels_rob}{\beamergotobutton{Robustness check}} \hyperlink{slide_compeffects_results}{\beamergotobutton{Back to slide}}
\end{frame}
...
\begin{frame}
\frametitle{Time trends in transport costs: Comments} %XXX ADJUST FROM HERE XXX
\begin{itemize}
...
\pause
\item \textbf{From the treatment of the additive component of transport costs} \hyperlink{app_compeffects_Hummels}{\beamergotobutton{More on this}}\vspace{0.1cm}
\begin{itemize}
...
%\includegraphics[width=1.25in, height=0.75in]{figure5_comme_hummels_base100.pdf}
%& \includegraphics[width=1.25in, height=0.75in]{figure6_comme_hummels_base100.pdf} \\
\end{tabular}
\end{center}
\end{figure}
...
%{\small (a) Ad-valorem Air Freight} & {\small (b) Ad-valorem Vessel Freight}\\
%\multicolumn{2}{c}{{\small In percent of the export price}} \\
%\includegraphics[width=1.25in, height=0.75in]{figure5_comme_hummels.pdf}
%& \includegraphics[width=1.25in, height=0.75in]{figure6_comme_hummels.pdf} \\
{\small (c) Ad-valorem Air Freight} & {\small (d) Ad-valorem Vessel Freight}\\
\multicolumn{2}{c}{{\small As indices with reference value 100 in 1974} }\\
...
\begin{itemize}
\item[-] See \hyperlink{slide_compeffects_figure}{\beamergotobutton{Figure 2}} \vspace{0.1cm}
\end{itemize}
\pause
...
\begin{frame}[label=app_variancedecomp]
\frametitle{Variance decomposition exercise}
\begin{figure}[htbp]
\caption{Variance decomposition (observed cif-fas price gap)}
\label{fig:decomp_variance}
\begin{center}
\includegraphics[width=8cm, height=6cm]{variance_decomposition.pdf}
%{\footnotesize {OECD data} }
\end{center}
\end{figure}
\hyperlink{slide_variancedecomp}{\beamergotobutton{Back to slide}}
...
\end{table}%
\hyperlink{slide_result1_more}{\beamergotobutton{Back to slide}}
\normalsize
\end{frame}
...
\hyperlink{slide_compeffects_figure}{\beamergotobutton{Back to main slide}}
\end{frame}
...
\end{itemize}
\hyperlink{slide_compeffects_comparison}{\beamergotobutton{Back to main slide}}
\end{frame}
