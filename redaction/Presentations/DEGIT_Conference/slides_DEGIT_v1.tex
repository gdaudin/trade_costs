...
\begin{itemize}
\item[-] The importance of modelling the additive component of transport costs \vspace{0.1cm}
...
\item For a product $k$, from country $i$ (for a given transport mode)   \vspace{0.1cm}
\item Rewrite to get:
\begin{equation}
