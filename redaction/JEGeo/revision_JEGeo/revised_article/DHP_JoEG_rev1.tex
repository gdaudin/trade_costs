...
Three main comments can be made. First, the subset of large trade flows we are considering (around 8\% of the observations of our initial sample, but the vast majority of the total value of aggregated trade (an annual mean of 68\% XXX D'OU VIENT CE CHIFFRE DE 68\% ?? N'est-ce pas 80\% ???).
