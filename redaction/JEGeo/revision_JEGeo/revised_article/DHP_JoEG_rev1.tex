...
\end{center}
{\parbox[l]{13cm}{ \vspace{4pt}\footnotesize{Notes: $f_x$ can take two values, depending on the share of exporters considered that might differ between the initial steady state (21\%, based on early 1980s' value) and the final steady state (39\%, based on 2000's value.), according to the references provided above. BEJK (2003) refers to \cite{BEJK-AER-03}.}}}
\end{table}
