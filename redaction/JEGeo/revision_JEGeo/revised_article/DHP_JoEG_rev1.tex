...
\subsubsection{Reducing fixed export costs}
...
The answer can be found in Table \ref{tab:resultats_modele}, by comparing Columns (B) to (D) for Air, (F) to (H) for Vessel, the difference between these two columns (for each transport mode) being the lower value of the fixed export cost. Here again, the welfare gains of trade liberalization (under the form of a lower fixed export cost) are larger when variable trade costs involve a part of additive costs: If the effect are quantitatively modest in maritime transport (by 0.75 percentage points, from 3.3\% to 4.05\%), the decrease in the fixed export cost is more sizeable when variable costs are lower, as in air transport where the welfare gains almost double (from 1.82\% to 3.25\%).


\begin{table}[htbp]
  \centering
  \caption{Trade liberalization: The role of additive costs} \label{tab:resultats_modele_decompwelfare}
\begin{center}
\begin{tabular}{l||c|c|c|c||c|c|c|c}
\hline
Mode & \multicolumn{4}{|c||}{Air} & \multicolumn{4}{c}{Vessel} \\ \hline
...
%$\Delta t/\widetilde{p}_x^{\text{fas}}$ (in pp) & 0&	-2.0&	0&	-2.0&	0&	-3.3&	0&	-3.3  \\ \hline
%$\Delta \mathcal{W}$ & 0.0202&	0.0295	&0.036&	0.053	&0.035&	0.052	&0.047&	0.064 \\
$\Delta \mathcal{W}/\mathcal{W}$ (in \%) & 1.232&	1.819&	2.207	&3.248	&2.179	&3.295&	2.872&	4.052   \\ \hline
Variety effect (\%)&	-0.827	&0.747	&-2.670&	-1.132	&-1.323	&-0.126&	-3.061	& -1.857 \\
Price effect (\%)&	2.084&	1.455	&5.202&	4.444&	3.568	&3.001&	6.829&	6.059 \\ 
\hline
\end{tabular}
\end{center}
