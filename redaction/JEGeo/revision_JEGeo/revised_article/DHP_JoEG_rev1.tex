...
\begin{minipage} [c]  {5in} \scriptsize%
Notes:The share of additive costs $\beta$ is reported on the $y-$axis. Each yearly value is obtained as: $\frac{\frac{\widehat{t}}{\widetilde{p}}}{\widehat{\tau}-1+\frac{\widehat{t}}{\widetilde{p}}}$, expressed in percent of the export price $\widetilde{p}$ (at the 3-digit level).
\end{minipage}
\end{center}
\end{figure}
