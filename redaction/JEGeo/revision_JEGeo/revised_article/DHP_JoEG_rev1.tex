...
Three main comments can be made. First, the subset of large trade flows we are considering (around 8\% of the observations of our initial sample, but the vast majority of the total value of aggregated trade)
\textbf{Ce n’est pas 80\% du commerce : voir le mode de calcul. Je sais que vous allez me demander combien c’est et je n’ai pas de réponse toute faite. Je peux passer une heure ou deux à le calculer si vous voulez -- GD}] involve a higher share of additive costs: between 48\% and 55\% of total costs on average, versus 30\% to 44\% on the whole sample.
