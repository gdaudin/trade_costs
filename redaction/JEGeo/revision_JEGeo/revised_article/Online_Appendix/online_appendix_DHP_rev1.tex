...
The situation is different in the primary sector. In this case, in air transport the composition effects matter more (Figure \ref{fig:totalTC_compeffects_excl_primary}, left-hand panels (a), (b) and (c)), while we observe not much role for them in vessel transport (Figure \ref{fig:totalTC_compeffects_excl_primary}, right-hand panels (d), (e) and (f)).
