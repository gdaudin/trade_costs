...
These motives altogether highlight that it would be too costly in our context to switch from weights to quantities to compute unit prices for our baseline regression. We hope to convince you that
