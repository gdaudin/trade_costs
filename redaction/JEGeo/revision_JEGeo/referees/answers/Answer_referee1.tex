...
%data from "vérification quantities.do"
...
The notion of per-unit shipping cost is one step removed for technical constraints and the functionning of the transportation sector.
...
These motives altogether highlight that it would be too costly in our context to switch from weights to quantities to compute unit prices for our baseline regression.
We then decided to maintain our original empirical strategy covering the whole period 1974-2019 in the revised version, and to extend the online Appendix with this supplementary robustness check.
