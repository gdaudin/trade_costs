...
\end{equation*}
\noindent where $p_{iku}$ refers to the cif price associated with quantity of goof $k$ imported from country $i$, measured in unit $u$, $\widetilde{p}_{iku}$ the corresponding unit value (fas price).
