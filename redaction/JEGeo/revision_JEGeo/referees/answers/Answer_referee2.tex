...
We do acknowledge this is very important was not made clear enough in the initial version, and did our best to make the point clear in the revised version (see p.8). We also devote more time to the robustness of the empirical specification. On top of the robustness to the separability assumption (already in the submitted version), we also assess the robustness to the degree of aggregation and endogeneity (Section 3.4). We hope that this new version now convinces you that our estimation strategy is both relevant and robust.
