...
Third, we exploit the time dimension of our database to document the patterns of transport costs over time. Between 1974 and 2013, we thus find that transport costs have decreased by roughly 50\% in air transport and 60\% in maritime transport, and of same order of magnitude for both additive and iceberg components. Importantly, and in contrast to \cite{hummels2007}, we do not find that composition effects do make a substantial difference in the time trends of international transport costs. 
These results therefore confirm the importance of the additive component in accounting for international transport costs.\smallskip

\textbf{paragraphe precedent a reprendre}
