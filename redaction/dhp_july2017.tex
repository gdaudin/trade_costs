...
As displayed in Figure \ref{fig:histogram_beta}, for both transport modes the distribution of $\beta_{ikt}$ over the triplet (year, product, origin country) is far from being concentrated on a single point. Rather, it appears smoothly distributed over the interval \[0,1\]. Note that the mode of the distribution stands around 0.3-0.4 depending of the transport mode, consistently with our previous findings.
