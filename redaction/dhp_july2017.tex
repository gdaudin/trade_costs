...
\begin{center}
\includegraphics[width=14cm, height=8cm]{Figure1_Trend_of_totalTC_bymode.pdf}
\end{center}
\end{figure}
...
Figure \ref{fig:totalTC_compeffects_excl} reports the results for all types of goods.\footnote{In the Online Appendix, we report the results at a more disaggregated level, distinguishing between primary and manufacturing goods.}\textbf{Et alors? Faire un commentaire et mettre l'annexe en ligne} In panels (a), (b) and (c) we report the time changes of the ad-valorem costs, the additive costs and the total costs respectively, for Air transport (starting from the reference value 100 in 1974). Panels (d), (e) and (f) report the results for Vessel. In each panel, we report the evolution of transport costs for both the unfitted (plain blue line) and the fitted (dotted red line) measures.
...
\begin{center}
 ...
 \multicolumn{5}{c}{3 digits} \\    \hline \hline
   ...
   Separability & No & Yes & No & Yes \\
    Additive term ($t/\widetilde{p}$. in \%) &       &       &       &  \\
    Mean  & \multicolumn{1}{c}{1.76} & \multicolumn{1}{c}{1.96} & \multicolumn{1}{c}{2.61} & \multicolumn{1}{c}{2.99} \\
    Median & \multicolumn{1}{c}{0.65} & \multicolumn{1}{c}{0.84} & \multicolumn{1}{c}{1.83} & \multicolumn{1}{c}{2.23} \\
    Ad-valorem term (\$\textbackslash{}tau\$. in \textbackslash{}\%) & \multicolumn{1}{c}{} & \multicolumn{1}{c}{} & \multicolumn{1}{c}{} & \multicolumn{1}{c}{} \\
    Mean  & \multicolumn{1}{c}{1.04} & \multicolumn{1}{c}{0.94} & \multicolumn{1}{c}{2.43} & \multicolumn{1}{c}{2.40} \\
    Median & \multicolumn{1}{c}{0.56} & \multicolumn{1}{c}{0.83} & \multicolumn{1}{c}{2.06} & \multicolumn{1}{c}{2.04} \\
    Diagnostic tests & \multicolumn{1}{c}{} & \multicolumn{1}{c}{} & \multicolumn{1}{c}{} & \multicolumn{1}{c}{} \\
    ...
    AIC criteria & \multicolumn{1}{c}{4657.60} & \multicolumn{1}{c}{4654.23} & \multicolumn{1}{c}{10744.83} & \multicolumn{1}{c}{10690.80} \\
    Log-likelihood & \multicolumn{1}{c}{-1757.75} & \multicolumn{1}{c}{-2258.24} & \multicolumn{1}{c}{-4018.51} & \multicolumn{1}{c}{-5220.00} \\ \hline
\# observations & \multicolumn{1}{c}{2381} & \multicolumn{1}{c}{2381} & \multicolumn{1}{c}{2798} & \multicolumn{1}{c}{2798} \\
\# origin country & \multicolumn{1}{c}{13.4} & \multicolumn{1}{c}{13.4} & \multicolumn{1}{c}{19.8} & \multicolumn{1}{c}{19.8} \\
\# products & \multicolumn{1}{c}{25.5} & \multicolumn{1}{c}{25.5} & \multicolumn{1}{c}{53} & \multicolumn{1}{c}{53}
    \end{tabular}%
\end{center}
...
A third difference is that we separate the country-product fixed effects ($\sum_{i,k}\alpha_{ik}.\mathbbm{1}_{ik}$ in Equation (\ref{eq:Hummels1})) in two separate components (origin country and product dimensions). As discussed in Section \ref{sec:robustness}, this is constrained by the number of fixed effects to estimate. However, we do not view this as the major cause of difference between our two methods, \textbf{as it can be inferred from the robustness analysis on this point in Section \ref{sec:robustness}. Ou on fait ca???}
