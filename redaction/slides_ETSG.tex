...
\begin{itemize}
\footnotesize{
\item[-] Additive trade costs, an important role in shaping the pattern of trade flows (the Alchian \& Allen (1964) conjecture) \vspace{0.1cm}
\item[-] A bunch of empirical papers in support of the additive hypothesis: Martin (2012), Hummels \& Skiba (2004), Irrarazabal et al. (2015) \vspace{0.1cm}
\item[-] With strong normative implications: Sorensen (2014), Irrarazabal et al. (2015) \vspace{0.1cm}}
\end{itemize}
...
\begin{itemize}
%\item Measure international transport costs as the difference between the export price and the import price \vspace{0.1cm}
\item Database: US annual imports of merchandise database \hyperlink{app_data}{\beamergotobutton{More}}\vspace{0.1cm}
\begin{itemize}
\item[-] Yearly basis, from 1974 to 2013, HS 10 digit classification level \vspace{0.1cm}
\item[-] The export (fas) price, $\widetilde{p}$: the price for one kg of merchandise at the country export gate \vspace{0.1cm}
\item[-] The import (cif) price, $p$: the price for one kg of merchandise at the US import gate \vspace{0.1cm}
\end{itemize}
...
\item For product $k$, from country $i$ (and by transport mode, air or vessel) \vspace{0.1cm}
\item Rewrite to get:
$$\frac{p_{ik}}{\widetilde{p}_{ik}} -1 = \tau_{ik} -1 +\frac{t_{ik}}{ \widetilde{p}_{ik}}$$
\item[$\Rightarrow$] Estimate this equation for each year over 1974-2013 (at the $k=$ 3-digit classification level)
\end{itemize}
\end{frame}
...
\end{equation}
\normalsize
\item A non-linear equation (due to the additive costs) $\rightarrow$ Estimation using non-linear squares \hyperlink{app_method}{\beamergotobutton{More}} \vspace{0.1cm}
...
\begin{itemize}
\item Transport costs expressed in percent of the export price, average values over 1974-2013 \hyperlink{app_results_summary}{\beamergotobutton{More}}  \vspace{0.1cm}
\begin{table}[htbp]
  \centering
  \scriptsize{
...
\item[] \hyperlink{slide_moreonfig1}{\beamergotobutton{More on this figure later}}
\end{itemize}
\begin{figure}[htbp]
...
\begin{itemize}
\item[-] On average over the period (Table 1) and on a yearly basis (Figure 1) \hyperlink{app_comments_fig1}{\beamergotobutton{More}}  \vspace{0.1cm}
\end{itemize}
...
\begin{itemize}
\item Coming back to Figure 1 \hyperlink{slide_fig1}{\beamergotobutton{Go}}: Downward trend in overall transport costs, for both air and ocean shipping \vspace{0.1cm}
\begin{itemize}
...
\item[$\Rightarrow$] Necessary to eliminate the composition effects of trade flows, to isolate the evolution of transport costs \textit{per se}  \vspace{0.1cm}
    \begin{itemize}
\item[-] What we do, in accordance with Hummels (2007) \hyperlink{app_compositioneffects}{\beamergotobutton{More on the method}}
\end{itemize}
\end{itemize}
\end{frame}
...
\frametitle{Ad-valorem costs over time \hyperlink{slide_comments_fig1}{\beamergotobutton{Back to slide}}}
\begin{figure}[htbp]
...
\end{itemize}
 \hyperlink{slide_moreonfig1}{\beamergotobutton{Back to slide}}
\end{frame}
