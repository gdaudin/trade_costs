*************************************************
* Programme 6 : Programme pour estimer les dÈterminants des trade costs - 2d stage
...
** La variable "cost_to-export" n'est renseignÈe qu'‡ partir de 2004, dans la benchmark regression on ne regarde que sur 2004-2013
...
* dans les variables de gravitÈ on ne considËre que distance
...
*sauver les rÈsultats : 1 .dta par mode/degrÈ de prÈcision
...
*** Lancer le programme d'estimation de la 2e Ètape
